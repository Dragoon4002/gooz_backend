...
class MonopolyServer {
    ...
    createGame(ws_2, _a) {
        return __awaiter(this, arguments, void 0, function* (ws, { playerName, colorCode, walletId, stakeAmount }) {
            ...
            const player = PlayerManager_1.PlayerManager.createPlayer(playerName, ws, colorCode || '#FF0000');
    ...
    joinGame(ws_2, gameId_1, _a) {
        return __awaiter(this, arguments, void 0, function* (ws, gameId, { playerName, colorCode, walletId, stakeAmount }) {
            ...
            const player = PlayerManager_1.PlayerManager.createPlayer(playerName, ws, colorCode);
            if (!game.addPlayer(player)) {
