...
export interface SubscriptionFundingTestInterface extends Interface {
    getFunction(nameOrSignature: "IS_TEST" | "consumersToAddToSubscription" | "excludeArtifacts" | "excludeContracts" | "excludeSelectors" | "excludeSenders" | "failed" | "setUp" | "targetArtifactSelectors" | "targetArtifacts" | "targetContracts" | "targetInterfaces" | "targetSelectors" | "targetSenders" | "test_CancelSubscription" | "test_CancelSubscription_WithPendingRequest_ShouldRevert" | "test_Deployment_Configurations" | "test_FulfillSignatureRequest_ForSubscriptionWithZeroBalance_ShouldRevert" | "test_FulfillSignatureRequest_ForSubscription_WithOnlyRequestPriceBalance" | "test_FulfillSignatureRequest_WithSubscription_AndLowCallbackGasLimit" | "test_FulfillSignatureRequest_WithSubscription_Successfully" | "test_FulfillSignatureRequest_WithZeroCallbackGasLimit" | "test_NoChargeAtRequestTime_ForSubscriptionRequest" | "test_Randomness_SignatureVerification" | "test_SelectArrayIndices_One_returnsAll" | "test_SelectArrayIndices_Zero_returnsEmpty" | "test_Update_SignatureScheme" | "test_selectArrayIndices_ReturnsCorrectCount"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "consumersToAddToSubscription", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "test_CancelSubscription", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_CancelSubscription_WithPendingRequest_ShouldRevert", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_Deployment_Configurations", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_FulfillSignatureRequest_ForSubscriptionWithZeroBalance_ShouldRevert", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_FulfillSignatureRequest_ForSubscription_WithOnlyRequestPriceBalance", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_FulfillSignatureRequest_WithSubscription_AndLowCallbackGasLimit", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_FulfillSignatureRequest_WithSubscription_Successfully", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_FulfillSignatureRequest_WithZeroCallbackGasLimit", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_NoChargeAtRequestTime_ForSubscriptionRequest", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_Randomness_SignatureVerification", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_SelectArrayIndices_One_returnsAll", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_SelectArrayIndices_Zero_returnsEmpty", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_Update_SignatureScheme", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_selectArrayIndices_ReturnsCorrectCount", values?: undefined): string;
    decodeFunctionResult(functionFragment: "IS_TEST", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "consumersToAddToSubscription", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "test_CancelSubscription", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_CancelSubscription_WithPendingRequest_ShouldRevert", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_Deployment_Configurations", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_FulfillSignatureRequest_ForSubscriptionWithZeroBalance_ShouldRevert", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_FulfillSignatureRequest_ForSubscription_WithOnlyRequestPriceBalance", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_FulfillSignatureRequest_WithSubscription_AndLowCallbackGasLimit", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_FulfillSignatureRequest_WithSubscription_Successfully", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_FulfillSignatureRequest_WithZeroCallbackGasLimit", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_NoChargeAtRequestTime_ForSubscriptionRequest", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_Randomness_SignatureVerification", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_SelectArrayIndices_One_returnsAll", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_SelectArrayIndices_Zero_returnsEmpty", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_Update_SignatureScheme", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_selectArrayIndices_ReturnsCorrectCount", data: BytesLike): Result;
}
...
export interface SubscriptionFundingTest extends BaseContract {
    connect(runner?: ContractRunner | null): SubscriptionFundingTest;
    waitForDeployment(): Promise<this>;
    interface: SubscriptionFundingTestInterface;
    ...
    consumersToAddToSubscription: TypedContractMethod<[
        arg0: BigNumberish
    ], [
        string
    ], "view">;
    ...
    test_CancelSubscription: TypedContractMethod<[], [void], "nonpayable">;
    test_CancelSubscription_WithPendingRequest_ShouldRevert: TypedContractMethod<[
    ], [
        void
    ], "nonpayable">;
    test_Deployment_Configurations: TypedContractMethod<[], [void], "view">;
    test_FulfillSignatureRequest_ForSubscriptionWithZeroBalance_ShouldRevert: TypedContractMethod<[
    ], [
        void
    ], "nonpayable">;
    test_FulfillSignatureRequest_ForSubscription_WithOnlyRequestPriceBalance: TypedContractMethod<[
    ], [
        void
    ], "nonpayable">;
    test_FulfillSignatureRequest_WithSubscription_AndLowCallbackGasLimit: TypedContractMethod<[
    ], [
        void
    ], "nonpayable">;
    test_FulfillSignatureRequest_WithSubscription_Successfully: TypedContractMethod<[
    ], [
        void
    ], "nonpayable">;
    test_FulfillSignatureRequest_WithZeroCallbackGasLimit: TypedContractMethod<[
    ], [
        void
    ], "nonpayable">;
    test_NoChargeAtRequestTime_ForSubscriptionRequest: TypedContractMethod<[
    ], [
        void
    ], "nonpayable">;
    test_Randomness_SignatureVerification: TypedContractMethod<[
    ], [
        void
    ], "view">;
    ...
    test_Update_SignatureScheme: TypedContractMethod<[], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "consumersToAddToSubscription"): TypedContractMethod<[arg0: BigNumberish], [string], "view">;
    ...
    getFunction(nameOrSignature: "excludeSelectors"): TypedContractMethod<[], [StdInvariant.FuzzSelectorStructOutput[]], "view">;
    ...
    getFunction(nameOrSignature: "test_CancelSubscription"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "test_CancelSubscription_WithPendingRequest_ShouldRevert"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "test_Deployment_Configurations"): TypedContractMethod<[], [void], "view">;
    getFunction(nameOrSignature: "test_FulfillSignatureRequest_ForSubscriptionWithZeroBalance_ShouldRevert"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "test_FulfillSignatureRequest_ForSubscription_WithOnlyRequestPriceBalance"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "test_FulfillSignatureRequest_WithSubscription_AndLowCallbackGasLimit"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "test_FulfillSignatureRequest_WithSubscription_Successfully"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "test_FulfillSignatureRequest_WithZeroCallbackGasLimit"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "test_NoChargeAtRequestTime_ForSubscriptionRequest"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "test_Randomness_SignatureVerification"): TypedContractMethod<[], [void], "view">;
    getFunction(nameOrSignature: "test_SelectArrayIndices_One_returnsAll"): TypedContractMethod<[], [void], "view">;
    getFunction(nameOrSignature: "test_SelectArrayIndices_Zero_returnsEmpty"): TypedContractMethod<[], [void], "view">;
    getFunction(nameOrSignature: "test_Update_SignatureScheme"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "test_selectArrayIndices_ReturnsCorrectCount"): TypedContractMethod<[], [void], "view">;
