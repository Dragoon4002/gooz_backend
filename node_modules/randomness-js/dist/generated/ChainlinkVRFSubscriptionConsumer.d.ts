...
export interface ChainlinkVRFSubscriptionConsumerInterface extends Interface {
    getFunction(nameOrSignature: "acceptOwnership" | "addConsumer" | "createSubscription" | "fundSubscriptionWithNative" | "getRandomWords" | "owner" | "randomWordsOf" | "rawFulfillRandomWords" | "requestId" | "requestRandomWords" | "s_vrfCoordinator" | "setCoordinator" | "setSubscription" | "transferOwnership"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "setSubscription", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "setSubscription", data: BytesLike): Result;
...
export interface ChainlinkVRFSubscriptionConsumer extends BaseContract {
    connect(runner?: ContractRunner | null): ChainlinkVRFSubscriptionConsumer;
    waitForDeployment(): Promise<this>;
    interface: ChainlinkVRFSubscriptionConsumerInterface;
    ...
    setSubscription: TypedContractMethod<[
        subId: BigNumberish
    ], [
        void
    ], "nonpayable">;
    ...
    getFunction(nameOrSignature: "setSubscription"): TypedContractMethod<[subId: BigNumberish], [void], "nonpayable">;
