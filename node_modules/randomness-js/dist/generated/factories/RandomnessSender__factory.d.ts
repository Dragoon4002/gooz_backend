...
export declare class RandomnessSender__factory extends ContractFactory {
    ...
    static readonly abi: readonly [{
        ...
        readonly inputs: readonly [{
            readonly name: "_signatureSender";
            readonly type: "address";
            readonly internalType: "address";
        }, {
            readonly name: "owner";
        ...
        readonly type: "function";
        readonly name: "signatureSender";
        readonly inputs: readonly [];
        readonly outputs: readonly [{
            readonly name: "";
            readonly type: "address";
            readonly internalType: "contract ISignatureSender";
        }];
        readonly stateMutability: "view";
    }, {
        readonly type: "function";
        ...
        readonly type: "function";
        readonly name: "withdrawDirectFundingFeesNative";
        readonly inputs: readonly [{
        ...
        readonly type: "function";
        readonly name: "withdrawSubscriptionFeesNative";
        readonly inputs: readonly [{
            readonly name: "recipient";
            readonly type: "address";
            readonly internalType: "address payable";
        ...
        readonly type: "event";
        readonly name: "RandomnessCallbackSuccess";
        readonly inputs: readonly [{
            readonly name: "requestID";
            readonly type: "uint256";
            readonly indexed: true;
        ...
        readonly type: "event";
        readonly name: "SignatureSenderUpdated";
        readonly inputs: readonly [{
            readonly name: "signatureSender";
            readonly type: "address";
            readonly indexed: true;
    ...
    static connect(address: string, runner?: ContractRunner | null): RandomnessSender;
}
export {};
