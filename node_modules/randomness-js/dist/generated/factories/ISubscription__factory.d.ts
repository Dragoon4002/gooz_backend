...
import type { ISubscription, ISubscriptionInterface } from "../ISubscription";
export declare class ISubscription__factory {
    ...
    static connect(address: string, runner?: ContractRunner | null): ISubscription;
}
