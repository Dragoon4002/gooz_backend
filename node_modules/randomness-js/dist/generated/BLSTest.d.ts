...
export declare namespace BLS {
    ...
    type PointG1StructOutput = [x: bigint, y: bigint] & {
        x: bigint;
        y: bigint;
    };
}
export interface BLSTestInterface extends Interface {
    getFunction(nameOrSignature: "IS_TEST" | "excludeArtifacts" | "excludeContracts" | "excludeSelectors" | "excludeSenders" | "failed" | "targetArtifactSelectors" | "targetArtifacts" | "targetContracts" | "targetInterfaces" | "targetSelectors" | "targetSenders" | "test__expandMsgTo96" | "test__hashToField" | "test__hashToPoint" | "test__isOnCurveG1" | "test__isOnCurveG2" | "test__isValidPublicKey" | "test__isValidSignature" | "test__mapToPoint" | "test__verifySingle"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "test__expandMsgTo96", values: [BytesLike, BytesLike]): string;
    encodeFunctionData(functionFragment: "test__hashToField", values: [BytesLike, BytesLike]): string;
    encodeFunctionData(functionFragment: "test__hashToPoint", values: [BytesLike, BytesLike]): string;
    encodeFunctionData(functionFragment: "test__isOnCurveG1", values: [[BigNumberish, BigNumberish]]): string;
    encodeFunctionData(functionFragment: "test__isOnCurveG2", values: [[BigNumberish, BigNumberish, BigNumberish, BigNumberish]]): string;
    encodeFunctionData(functionFragment: "test__isValidPublicKey", values: [[BigNumberish, BigNumberish, BigNumberish, BigNumberish]]): string;
    encodeFunctionData(functionFragment: "test__isValidSignature", values: [[BigNumberish, BigNumberish]]): string;
    encodeFunctionData(functionFragment: "test__mapToPoint", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "test__verifySingle", values: [
        [
            BigNumberish,
            BigNumberish
        ],
    ...
    decodeFunctionResult(functionFragment: "test__expandMsgTo96", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test__hashToField", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test__hashToPoint", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test__isOnCurveG1", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test__isOnCurveG2", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test__isValidPublicKey", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test__isValidSignature", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test__mapToPoint", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test__verifySingle", data: BytesLike): Result;
}
...
export interface BLSTest extends BaseContract {
    ...
    getFunction(nameOrSignature: "test__expandMsgTo96"): TypedContractMethod<[
        domain: BytesLike,
        message: BytesLike
    ], [
        [string, bigint] & {
    ...
    getFunction(nameOrSignature: "test__hashToField"): TypedContractMethod<[
        domain: BytesLike,
        message: BytesLike
    ], [
        [[bigint, bigint], bigint] & {
    ...
    getFunction(nameOrSignature: "test__hashToPoint"): TypedContractMethod<[
        domain: BytesLike,
        message: BytesLike
    ], [
        [
    ...
    getFunction(nameOrSignature: "test__isOnCurveG1"): TypedContractMethod<[
        point: [BigNumberish, BigNumberish]
    ], [
        [boolean, bigint] & {
            _isOnCurve: boolean;
    ...
    getFunction(nameOrSignature: "test__isOnCurveG2"): TypedContractMethod<[
        point: [BigNumberish, BigNumberish, BigNumberish, BigNumberish]
    ], [
        [boolean, bigint] & {
            _isOnCurve: boolean;
    ...
    getFunction(nameOrSignature: "test__isValidPublicKey"): TypedContractMethod<[
        publicKey: [BigNumberish, BigNumberish, BigNumberish, BigNumberish]
    ], [
        [boolean, bigint] & {
            isValid: boolean;
    ...
    getFunction(nameOrSignature: "test__isValidSignature"): TypedContractMethod<[
        signature: [BigNumberish, BigNumberish]
    ], [
        [boolean, bigint] & {
            isValid: boolean;
    ...
    getFunction(nameOrSignature: "test__mapToPoint"): TypedContractMethod<[
        value: BigNumberish
    ], [
        [[bigint, bigint], bigint] & {
            p: [bigint, bigint];
    ...
    getFunction(nameOrSignature: "test__verifySingle"): TypedContractMethod<[
        signature: [BigNumberish, BigNumberish],
        pubkey: [BigNumberish, BigNumberish, BigNumberish, BigNumberish],
        message: [BigNumberish, BigNumberish]
    ], [
