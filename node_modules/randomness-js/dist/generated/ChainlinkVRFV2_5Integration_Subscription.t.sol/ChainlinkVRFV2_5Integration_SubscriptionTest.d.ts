...
export interface ChainlinkVRFV2_5Integration_SubscriptionTestInterface extends Interface {
    getFunction(nameOrSignature: "IS_TEST" | "excludeArtifacts" | "excludeContracts" | "excludeSelectors" | "excludeSenders" | "failed" | "setUp" | "targetArtifactSelectors" | "targetArtifacts" | "targetContracts" | "targetInterfaces" | "targetSelectors" | "targetSenders" | "test_chainlinkFulfillSignatureRequest_WithSubscription_Successfully"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "test_chainlinkFulfillSignatureRequest_WithSubscription_Successfully", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "test_chainlinkFulfillSignatureRequest_WithSubscription_Successfully", data: BytesLike): Result;
}
...
export interface ChainlinkVRFV2_5Integration_SubscriptionTest extends BaseContract {
    connect(runner?: ContractRunner | null): ChainlinkVRFV2_5Integration_SubscriptionTest;
    waitForDeployment(): Promise<this>;
    interface: ChainlinkVRFV2_5Integration_SubscriptionTestInterface;
    ...
    test_chainlinkFulfillSignatureRequest_WithSubscription_Successfully: TypedContractMethod<[
    ], [
        void
    ], "nonpayable">;
    ...
    getFunction(nameOrSignature: "test_chainlinkFulfillSignatureRequest_WithSubscription_Successfully"): TypedContractMethod<[], [void], "nonpayable">;
