...
export interface BytesLibInterface extends Interface {
    ...
    encodeFunctionData(functionFragment: "decodeBytesToUint", values: [BytesLike]): string;
    decodeFunctionResult(functionFragment: "decodeBytesToUint", data: BytesLike): Result;
}
export interface BytesLib extends BaseContract {
    ...
    getFunction(nameOrSignature: "decodeBytesToUint"): TypedContractMethod<[data: BytesLike], [bigint], "view">;
    filters: {};
}
