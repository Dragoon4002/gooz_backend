...
export interface MockRevertingRandomnessReceiverInterface extends Interface {
    getFunction(nameOrSignature: "acceptOwnership" | "cancelSubscription" | "createSubscriptionAndFundNative" | "getBalance" | "isInFlight" | "owner" | "pendingRequestExists" | "randomness" | "randomnessSender" | "receiveRandomness" | "requestId" | "rollDiceWithDirectFunding" | "rollDiceWithSubscription" | "setRandomnessSender" | "setSubId" | "subscriptionId" | "topUpSubscriptionNative" | "transferOwnership" | "updateSubscription"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "randomness", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "rollDiceWithDirectFunding", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "rollDiceWithSubscription", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "rollDiceWithDirectFunding", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "rollDiceWithSubscription", data: BytesLike): Result;
...
export interface MockRevertingRandomnessReceiver extends BaseContract {
    connect(runner?: ContractRunner | null): MockRevertingRandomnessReceiver;
    waitForDeployment(): Promise<this>;
    interface: MockRevertingRandomnessReceiverInterface;
    ...
    getFunction(nameOrSignature: "randomness"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "rollDiceWithDirectFunding"): TypedContractMethod<[
        callbackGasLimit: BigNumberish
    ], [
        [bigint, bigint]
    ], "payable">;
    getFunction(nameOrSignature: "rollDiceWithSubscription"): TypedContractMethod<[
        callbackGasLimit: BigNumberish
    ], [
        bigint
    ], "nonpayable">;
