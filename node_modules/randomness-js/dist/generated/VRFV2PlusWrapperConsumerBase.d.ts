...
export interface VRFV2PlusWrapperConsumerBaseInterface extends Interface {
    getFunction(nameOrSignature: "getBalance" | "getLinkToken" | "i_vrfV2PlusWrapper" | "rawFulfillRandomWords"): FunctionFragment;
    encodeFunctionData(functionFragment: "getBalance", values?: undefined): string;
    encodeFunctionData(functionFragment: "getLinkToken", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "getLinkToken", data: BytesLike): Result;
...
export interface VRFV2PlusWrapperConsumerBase extends BaseContract {
    ...
    getFunction(nameOrSignature: "getLinkToken"): TypedContractMethod<[], [string], "view">;
