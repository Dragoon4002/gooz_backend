...
export interface DirectFundingTestInterface extends Interface {
    getFunction(nameOrSignature: "IS_TEST" | "excludeArtifacts" | "excludeContracts" | "excludeSelectors" | "excludeSenders" | "failed" | "setUp" | "targetArtifactSelectors" | "targetArtifacts" | "targetContracts" | "targetInterfaces" | "targetSelectors" | "targetSenders" | "test_CallbackShouldNotRevert_IfInterfaceIsNotImplemented" | "test_Deployment_Configurations" | "test_FulfillDecryptionRequest_WithLowCallbackGasLimit" | "test_FulfillDecryptionRequest_WithRevertingReceiver" | "test_FulfillDecryptionRequest_WithZeroCallbackGasLimit" | "test_FulfillSignatureRequest_WithDirectFunding_Successfully" | "test_Randomness_SignatureVerification" | "test_SelectArrayIndices_One_returnsAll" | "test_SelectArrayIndices_Zero_returnsEmpty" | "test_Update_SignatureScheme" | "test_selectArrayIndices_ReturnsCorrectCount"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "RandomnessCallbackFailed" | "RandomnessRequested" | "log" | "log_address" | "log_array(uint256[])" | "log_array(int256[])" | "log_array(address[])" | "log_bytes" | "log_bytes32" | "log_int" | "log_named_address" | "log_named_array(string,uint256[])" | "log_named_array(string,int256[])" | "log_named_array(string,address[])" | "log_named_bytes" | "log_named_bytes32" | "log_named_decimal_int" | "log_named_decimal_uint" | "log_named_int" | "log_named_string" | "log_named_uint" | "log_string" | "log_uint" | "logs"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "test_CallbackShouldNotRevert_IfInterfaceIsNotImplemented", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_Deployment_Configurations", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_FulfillDecryptionRequest_WithLowCallbackGasLimit", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_FulfillDecryptionRequest_WithRevertingReceiver", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_FulfillDecryptionRequest_WithZeroCallbackGasLimit", values?: undefined): string;
    encodeFunctionData(functionFragment: "test_FulfillSignatureRequest_WithDirectFunding_Successfully", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "test_CallbackShouldNotRevert_IfInterfaceIsNotImplemented", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_Deployment_Configurations", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_FulfillDecryptionRequest_WithLowCallbackGasLimit", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_FulfillDecryptionRequest_WithRevertingReceiver", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_FulfillDecryptionRequest_WithZeroCallbackGasLimit", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "test_FulfillSignatureRequest_WithDirectFunding_Successfully", data: BytesLike): Result;
...
export interface DirectFundingTest extends BaseContract {
    connect(runner?: ContractRunner | null): DirectFundingTest;
    waitForDeployment(): Promise<this>;
    interface: DirectFundingTestInterface;
    ...
    test_CallbackShouldNotRevert_IfInterfaceIsNotImplemented: TypedContractMethod<[
    ], [
        void
    ], "nonpayable">;
    test_Deployment_Configurations: TypedContractMethod<[], [void], "view">;
    test_FulfillDecryptionRequest_WithLowCallbackGasLimit: TypedContractMethod<[
    ], [
        void
    ], "nonpayable">;
    test_FulfillDecryptionRequest_WithRevertingReceiver: TypedContractMethod<[
    ], [
        void
    ], "nonpayable">;
    test_FulfillDecryptionRequest_WithZeroCallbackGasLimit: TypedContractMethod<[
    ], [
        void
    ], "nonpayable">;
    test_FulfillSignatureRequest_WithDirectFunding_Successfully: TypedContractMethod<[
    ], [
        void
    ], "nonpayable">;
    ...
    getFunction(nameOrSignature: "test_CallbackShouldNotRevert_IfInterfaceIsNotImplemented"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "test_Deployment_Configurations"): TypedContractMethod<[], [void], "view">;
    getFunction(nameOrSignature: "test_FulfillDecryptionRequest_WithLowCallbackGasLimit"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "test_FulfillDecryptionRequest_WithRevertingReceiver"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "test_FulfillDecryptionRequest_WithZeroCallbackGasLimit"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "test_FulfillSignatureRequest_WithDirectFunding_Successfully"): TypedContractMethod<[], [void], "nonpayable">;
