...
export interface ChainlinkVRFV2_5Integration_SubscriptionTestInterface
  extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_chainlinkFulfillSignatureRequest_WithSubscription_Successfully"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_chainlinkFulfillSignatureRequest_WithSubscription_Successfully",
    values?: undefined
  ): string;
...
export interface ChainlinkVRFV2_5Integration_SubscriptionTest
  extends BaseContract {
  connect(
    runner?: ContractRunner | null
  ): ChainlinkVRFV2_5Integration_SubscriptionTest;
  ...
  getFunction(
    nameOrSignature: "test_chainlinkFulfillSignatureRequest_WithSubscription_Successfully"
  ): TypedContractMethod<[], [void], "nonpayable">;
