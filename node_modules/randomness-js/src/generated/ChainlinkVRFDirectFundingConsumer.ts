...
export interface ChainlinkVRFDirectFundingConsumerInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getRandomWords",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "randomWordsOf",
...
export interface ChainlinkVRFDirectFundingConsumer extends BaseContract {
  ...
  requestRandomWords: TypedContractMethod<
    [callbackGasLimit: BigNumberish, arg1: boolean],
    [bigint],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "getRandomWords"
