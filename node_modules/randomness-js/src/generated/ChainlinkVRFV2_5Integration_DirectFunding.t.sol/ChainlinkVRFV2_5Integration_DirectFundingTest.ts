...
export interface ChainlinkVRFV2_5Integration_DirectFundingTestInterface
  extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_chainlinkFulfillSignatureRequest_WithDirectFunding_Successfully"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_chainlinkFulfillSignatureRequest_WithDirectFunding_Successfully",
    values?: undefined
  ): string;
...
export interface ChainlinkVRFV2_5Integration_DirectFundingTest
  ...
  getFunction(
    nameOrSignature: "test_chainlinkFulfillSignatureRequest_WithDirectFunding_Successfully"
  ): TypedContractMethod<[], [void], "nonpayable">;
